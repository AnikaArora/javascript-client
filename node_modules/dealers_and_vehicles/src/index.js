...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Answer', 'model/AnswerResponse', 'model/DatasetIdResponse', 'model/DealerAnswer', 'model/DealersResponse', 'model/VehicleAnswer', 'model/VehicleIdsResponse', 'model/VehicleResponse', 'api/DataSetApi', 'api/DealersApi', 'api/VehiclesApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Answer'), require('./model/AnswerResponse'), require('./model/DatasetIdResponse'), require('./model/DealerAnswer'), require('./model/DealersResponse'), require('./model/VehicleAnswer'), require('./model/VehicleIdsResponse'), require('./model/VehicleResponse'), require('./api/DataSetApi'), require('./api/DealersApi'), require('./api/VehiclesApi'));
  }
}(function(ApiClient, Answer, AnswerResponse, DatasetIdResponse, DealerAnswer, DealersResponse, VehicleAnswer, VehicleIdsResponse, VehicleResponse, DataSetApi, DealersApi, VehiclesApi) {
  'use strict';
